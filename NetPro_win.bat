...
@start /ABOVENORMAL javaw.exe -Xmn128m -Xmx1g -Xms1g -server -XX:+TieredCompilation -XX:+AggressiveOpts -XX:+UseConcMarkSweepGC -javaagent:l2emuproject-netpro-app-0.8-SNAPSHOT.jar -jar l2emuproject-netpro-app-0.8-SNAPSHOT.jar
